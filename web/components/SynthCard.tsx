...
const RANGES: Record<string, NumSpec> = {
  ...
  // Envelope times span the full engine range (controls clamps to
  // [0.0001, 10] s) — a smaller slider max would snap knob-page-set
  // values back down on the next drag.
  "filter_env.attack": { min: 0, max: 10, step: 0.001, fmt: fmtSec },
  "filter_env.decay": { min: 0, max: 10, step: 0.001, fmt: fmtSec },
  "filter_env.sustain": { min: 0, max: 1, step: 0.01, fmt: fmt2 },
  "filter_env.release": { min: 0, max: 10, step: 0.001, fmt: fmtSec },
  "filter_env.amount": { min: 0, max: 1, step: 0.01, fmt: fmt2 },
  "amp_env.attack": { min: 0, max: 10, step: 0.001, fmt: fmtSec },
  "amp_env.decay": { min: 0, max: 10, step: 0.001, fmt: fmtSec },
  "amp_env.sustain": { min: 0, max: 1, step: 0.01, fmt: fmt2 },
  "amp_env.release": { min: 0, max: 10, step: 0.001, fmt: fmtSec },
